...
![f(g(x))](image/Screenshot from 2022-12-16 16-50-50.png){#fig:002 width=70%}

Проверим ее работу (рис. [-@fig:003)

![-](image/Снимок экрана от 2022-12-15 13-25-59.png){#fig:003 width=70%}
...
![-](image/Снимок экрана от 2022-12-15 14-33-01.png){#fig:012 width=70%}

![-](image/Снимок экрана от 2022-12-15 14-39-14.png){#fig:013 width=70%}

Так же отладчик позволяет менять значения переменных прямо во время выполнения программы (рис. [-@fig:014])

![-](image/Screenshot from 2022-12-16 13-51-33.png){#fig:014 width=70%}
...
![-](image/Screenshot from 2022-12-16 13-58-31.png){#fig:015 width=70%}
...
![-](image/Screenshot from 2022-12-16 14-07-18.png){#fig:016 width=70%}

Как и переменным, регистрам можно задавать значения.(рис. [-@fig:017])

![-](image/Screenshot from 2022-12-16 14-09-22.png){#fig:017 width=70%}
...
![-](image/Screenshot from 2022-12-16 14-23-35.png){#fig:018 width=70%}

Посмотрим на содержимое того,что расположено по адрессу, находящемуся в регистре esp (рис. [-@fig:019])

![-](image/Screenshot from 2022-12-16 14-26-12.png){#fig:019 width=70%}
...
![-](image/Screenshot from 2022-12-16 14-32-23.png){#fig:020 width=70%}

# Задания для самостоятельной работы

Программа из лабороторной 9, но с использованием подпрограмм (рис. [-@fig:021])

![-](image/Screenshot from 2022-12-16 14-52-17.png){#fig:021 width=70%}

и проверка ее работоспособности(рис. [-@fig:022])

![-](image/Screenshot from 2022-12-16 14-57-25.png){#fig:022 width=70%}

Просмотр регистров, для поиска ошибки в программе из листинга 10.3 (рис. [-@fig:023]) и (рис. [-@fig:024])

![-](image/Screenshot from 2022-12-16 16-09-31.png){#fig:023 width=70%}

![-](image/Screenshot from 2022-12-16 16-09-48.png){#fig:024 width=70%}
...
![-](image/Screenshot from 2022-12-16 16-18-10.png){#fig:025 width=70%}

Проверка корректронсти работы программы, после исправлений (рис. [-@fig:026])

![-](image/Screenshot from 2022-12-16 16-18-30.png){#fig:026 width=70%}
